...
* unbindrepo - Отключить конфигурацию от хранилища
* bindrepo  - Подключить конфигурацию к хранилищу
...
## bindrepo - Подключить конфигурацию к хранилищу. Приводит в появлению ключа запуска Конфигуратора ConfigurationRepositoryBindCfg -forceBindAlreadyBindedUser -forceReplaceCfg
